...
if recomendação != None:
    ...
    st.text("Imagina ficar sabendo minutos antes de contratar um jogador por milhões de euros que existe outro jogador \nno mercado com uma performance equivalente (ou até melhor) e muito mais barata.\nEste app identifica eventuais oportunidades de negócio no futebol brasileiro.")
